package com.zgk.arcfacedemo.common;

public class Constants {
    public static final String APP_ID = "6B2nBwW6fUVhKUeNBkrLAxnMqvUAEzXVfhYTQkadi1kC";
    public static final String SDK_KEY = "8jxpXWwvsWspM4HJf2H2ayQGCLtqFTWDdpm1uBxJ5Ey9";
